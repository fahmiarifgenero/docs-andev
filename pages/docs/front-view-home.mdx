...
![Dasboard Home](/images/front-view/layouts/home.png)
...
3. Menu Informasi menampilkan informasi waktu, icon home, icon tanda tanya, dan icon user
   ...
   ![informasi home dashboard](/images/front-view/layouts//informasi-home-dashboard.png)
...
![Navbar dashboard](/images/front-view/layouts/navbar.png)

Navigasi untuk mengarahkan user ke halaman - halaman yang ada pada aplikasi ini.

### Bagian Content

![Body Content](/images/front-view/layouts/content.png)
